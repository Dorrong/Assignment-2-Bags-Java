...
public class ArrayBag<T> implements BagInterface<T> {
	...
	*/
	...
	/* INCLUDE YOUR CODE BELOW !!!!!!!!!  */
		 ...
		 if (aBag.getCurrentSize() != this.getCurrentSize()) return result;
			 
		 for (int index =0; index <numberOfEntries; index++)
	        {
	            if (getFrequencyOf(bag[index])!=aBag.getFrequencyOf(bag[index])) 
	...
	/* INCLUDE YOUR CODE BELOW !!!!!!!!!  */
	   ...
	   }//closes removeAllDuplicates method
} // end ArrayBag